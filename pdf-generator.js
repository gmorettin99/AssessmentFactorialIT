...
function generateStrategicPDF(score, data) {
    ...
    /**
 * FACTORIAL IT: BESPOKE STRATEGIC PDF GENERATOR
 * Includes framewhite.png logo and clean dynamic data.
 */
...
function generateStrategicPDF(score, data) {
    ...
    let html = `
        <div style="display: flex; justify-content: space-between; align-items: flex-start; margin-bottom: 20px;">
            ...
            <div style="text-align: right; color: #ff585d; font-weight: bold; font-size: 10px;">
    ...
    const opt = {
        ...
        html2canvas: { scale: 2, useCORS: true }, // useCORS is required to load the image from a URL
